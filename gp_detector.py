...
if __name__ == '__main__': 
    ...
    for iterate in iteration:
        ...
        k1 = GPy.kern.Exponential(input_dim, variance=1.0, lengthscale=0.001)
        ...
        if not(os.path.isdir(f'{os.getcwd()}/saved_models/GP')):
            os.mkdir(f'{os.getcwd()}/saved_models/GP')
            
        m.save_model(f"saved_models/GP/{FLAGS.dataset}_{FLAGS.attack}.gp")
